...
const lazyload_images = document.querySelectorAll("img");
...
var crumbs_default = /*#__PURE__*/__webpack_require__.n(crumbs);
;// CONCATENATED MODULE: ./src/js/cookieconsent.js
...
const cookieNoticerCk = crumbs_default().get('acceptedCookies');
const cookieNoticerLs = crumbs_default().ls.get('acceptedCookies');
...
function setCookie(type, accepted) {
  ...
  return type === 'localStorage' ? crumbs_default().ls.set("acceptedCookies", validation, {
    type: "day",
    value: 7
  }, "/crumbsjs") : type === 'all' ? crumbs_default().ls.set("acceptedCookies", validation, {
    type: "day",
    value: 7
  }, "/crumbsjs") && crumbs_default().set("acceptedCookies", validation, {
    type: "day",
    value: 7
  }, "/crumbsjs") : crumbs_default().set("acceptedCookies", validation, {
    type: "day",
...
function computeStyles(_ref4) {
  ...
  if (true) {
    var transitionProperty = getComputedStyle_getComputedStyle(state.elements.popper).transitionProperty || '';
    ...
    var instance = {
      ...
      setOptions: function setOptions(options) {
        ...
        if (true) {
          ...
          var _getComputedStyle = getComputedStyle_getComputedStyle(popper),
...
var bootstrap_esm_isElement = function isElement(obj) {
...
var typeCheckConfig = function typeCheckConfig(componentName, config, configTypes) {
  Object.keys(configTypes).forEach(function (property) {
    ...
    var valueType = value && bootstrap_esm_isElement(value) ? 'element' : toType(value);
...
const scripts_elements = ['.has-js-flip', '.googlemap_textright', '#trainingsaanbod'];
  ...
  if (document.querySelector(element) !== null && document.querySelector(element) !== undefined) {
    const lazyloadHandler = onVisibilityChange(document.querySelector(element), function () {
      ...
      if (element === '.has-js-flip') {
        const Filters = __webpack_require__.e(/*! import() */ "src_js_flip_js").then(__webpack_require__.t.bind(__webpack_require__, /*! ./flip */ "./src/js/flip.js", 23));
      }

      if (element === '.googlemap_textright') {
        const Filters = Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_jquery_dist_jquery_js"), __webpack_require__.e("src_js_googlemap_js")]).then(__webpack_require__.t.bind(__webpack_require__, /*! ./googlemap */ "./src/js/googlemap.js", 23));
      }

      if (element === '#trainingsaanbod') {
        const Filters = Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_jquery_dist_jquery_js"), __webpack_require__.e("src_js_trainingsaanbod_js")]).then(__webpack_require__.t.bind(__webpack_require__, /*! ./trainingsaanbod */ "./src/js/trainingsaanbod.js", 23));
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("b5460716bad83142f887")
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "prikr-wp-starter:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdateprikr_wp_starter"] = (chunkId, moreModules, runtime) => {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkprikr_wp_starter"] = self["webpackChunkprikr_wp_starter"] || [];
