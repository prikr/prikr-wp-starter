...
const scripts_elements = ['.tdfilters'];
[].forEach.call(scripts_elements, element => {
  if (document.querySelector(element) !== null && document.querySelector(element) !== undefined) {
    const lazyloadHandler = onVisibilityChange(document.querySelector(element), function () {// Example library without init:
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("f5d740662500b0e65323")
/******/ 	})();
/******/ 	
